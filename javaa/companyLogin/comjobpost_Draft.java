...
//	        System.out.println("login button clicked successfully");
        ...
        System.out.println("add to jobpost button clicked");
	       ...
	       System.out.println("jobcode filled successfully");
	        ...
	        jobTitlElement.sendKeys("seleTwel");
...
//	        dateInput.click();
//	        System.out.println("datepicker is click successfully");
//
//	        WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(10));
//	        WebElement startDate = wait1.until(ExpectedConditions.elementToBeClickable(
//	            By.xpath("//span[contains(@class, 'flatpickr-day') and text()='19']")));
//	        System.out.println("statr date datepicker is selected successfully");
//	        startDate.click();
//	        
	     ...
	     // Start Date Selection
	        ...
	        // Click to open End Date Calendar
...
//	         driver.findElement(By.id("Pick a start date")).click();
//	        System.out.println("calender selected successfully");
//	        driver.findElement(By.xpath("//span[text()='8' and contains(@class,'flatpickr-day')]")).click();
//	        System.out.println("date is selected");
	        
//	        WebElement expense= driver.findElement(By.xpath("//*[@id=\"kt_app_content\"]/form/div[4]/div[1]/div/div/div/div[1]/label[1]/span"));
//	        expense.click();
...
//        WebDriverWait wait1w11 = new WebDriverWait(driver, Duration.ofSeconds(10));
//        wait1w11.until(ExpectedConditions.visibilityOfElementLocated(By.className("flatpickr-calendar")));
//        System.out.println("Visible month: " + driver.findElement(By.cssSelector(".flatpickr-current-month")).getText());
//
//        // Navigate to May 2025 (example)
//        while (true) {
...
//        }
//     // Start Date Selection
//        WebDriverWait wait1e1 = new WebDriverWait(driver, Duration.ofSeconds(10));
//        WebElement startgDate = wait1e1.until(ExpectedConditions.elementToBeClickable(
//            By.xpath("//span[contains(@class, 'flatpickr-day') and not(contains(@class, 'disabled')) and text()='19']")));
//        startgDate.click();
//        System.out.println("Start G date selected");

        
//        
//        WebDriverWait wait21 = new WebDriverWait(driver, Duration.ofSeconds(10));
//        wait21.until(ExpectedConditions.visibilityOfElementLocated(By.className("form-control form-control-solid flatpickr-input form-control-lg")));
//        System.out.println("Visible month: " + driver.findElement(By.cssSelector(".flatpickr-monthDropdown-months")).getText());
//
//        // Navigate to May 2025 (example)
//        while (true) {
//            String visibleMonth = driver.findElement(By.cssSelector(".flatpickr-monthDropdown-months")).getText();
//            if (visibleMonth.contains("June")) {
//                break;
//            } else {
//                driver.findElement(By.cssSelector(".flatpickr-monthDropdown-months")).click();
//            }
//        }
//     // Start Date Selection
//        WebDriverWait wait22 = new WebDriverWait(driver, Duration.ofSeconds(10));
//        WebElement LastDate = wait22.until(ExpectedConditions.visibilityOfElementLocated(
//        	    By.cssSelector("input.form-control.form-control-solid.flatpickr-input.form-control-lg")));
//
//        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'center'});", LastDate);
//        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", LastDate);
//        LastDate.click();
//        System.out.println("last calender date filled selected");
	    //Thread.sleep(5000);
	 ...
	 // You can now interact with top-of-page elements
	    JavascriptExecutor saveD = (JavascriptExecutor) driver;

	 // Scroll to bottom of page first
	    saveD.executeScript("window.scrollTo(0, document.body.scrollHeight);");
	 Thread.sleep(500); // Wait a bit for smooth scrolling

	 // Now scroll back up to the element and click
	 WebElement creatElement = driver.findElement(By.xpath("//button[normalize-space()='Save as Draft']"));
	 saveD.executeScript("arguments[0].scrollIntoView(true);", creatElement);
	 Thread.sleep(300); // optional
	 saveD.executeScript("arguments[0].click();", creatElement);

	 System.out.println("save to draft button clicked, scroll from bottom to top and clicked.");
